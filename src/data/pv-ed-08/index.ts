...
import { stage01 } from './stages/01-pv-consulting-foundations';
import { stage02 } from './stages/02-competency-needs-analysis-gap-assessment';
import { stage03 } from './stages/03-solution-design-program-customization';
import { stage04 } from './stages/04-value-delivery-quick-wins';
import { stage05 } from './stages/05-education-to-consulting-integration';
import { stage06 } from './stages/06-client-success-metrics-roi';
import { stage07 } from './stages/07-comprehensive-client-transformation-strategy';
