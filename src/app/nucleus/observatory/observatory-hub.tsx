...
const LIFECYCLE_SECTIONS: Section[] = [
  {
    ...
    href: '/nucleus/observatory/chemistry',
  ...
  },
  {
    ...
    href: '/nucleus/observatory/molecule',
  ...
  },
  {
    ...
    href: '/nucleus/observatory/regulatory',
  ...
  },
  {
    ...
    href: '/nucleus/observatory/causality',
  ...
  },
  {
    ...
    href: '/nucleus/observatory/timeline',
  ...
  },
  {
    ...
    href: '/nucleus/observatory/epidemiology',
...
const PLATFORM_SECTIONS: Section[] = [
  {
    ...
    href: '/nucleus/observatory/graph',
    explorerType: 'graph',
    icon: Network,
  ...
  },
  {
    ...
    href: '/nucleus/observatory/state',
    explorerType: 'state',
    icon: Orbit,
  ...
  },
  {
    ...
    href: '/nucleus/observatory/careers',
    explorerType: 'career',
    icon: Briefcase,
  ...
  },
  {
    ...
    href: '/nucleus/observatory/learning',
  ...
  },
  {
    ...
    href: '/nucleus/observatory/atlas',
    explorerType: 'atlas',
    icon: Dna,
    borderClass: 'border-teal-500/30',
    bgClass: 'bg-teal-500/5',
