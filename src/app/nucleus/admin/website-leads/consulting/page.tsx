...
import { ConsultingLeadsClient } from './consulting-leads-client';

export const metadata = createMetadata({
  title: 'Consulting Leads',
  description: 'View and manage enterprise consulting inquiry submissions with lead scoring',
  path: '/nucleus/admin/website-leads/consulting',
});

export default function ConsultingLeadsPage() {
  return (
      ...
      <div className="border-b border-nex-light bg-nex-surface/95 backdrop-blur supports-[backdrop-filter]:bg-nex-surface/60 px-4 lg:px-6 py-golden-3">
        <div className="flex items-center gap-golden-2">
          ...
          <div>
            ...
            <h1 className="text-sm font-semibold text-white">Consulting Leads</h1>
          </div>
        </div>
      </div>
      <main className="flex-1 space-y-golden-2 p-4 pt-golden-3 md:p-8">
        <ConsultingLeadsClient />
      </main>
    </div>
  );
}
