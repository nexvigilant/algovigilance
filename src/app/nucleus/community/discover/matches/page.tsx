...
export default function CircleMatchesPage() {
  ...
  async function loadMatches() {
    ...
    if (!stored) {
      // No quiz data, redirect to discovery
  ...
  async function handleJoin(circle: SmartForum) {
    ...
    // Check if this circle has a request form
  ...
  function handleCreateNew() {
    router.push('/nucleus/community/circles/create');
  }
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        <CardTitle className="text-lg text-slate-light">
                          <Link
                            href={`/nucleus/community/circles/${match.circle.id}`}
