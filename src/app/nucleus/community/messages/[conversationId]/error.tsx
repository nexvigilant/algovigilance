...
const log = logger.scope("community/messages/conversation");
...
export default function ConversationError({
  ...
  useEffect(() => {
    log.error("Conversation error boundary caught:", error);
    reportError(error, {
      component: "ConversationError",
      route: "/nucleus/community/messages/[conversationId]",
      digest: error.digest,
    });
  }, [error]);
