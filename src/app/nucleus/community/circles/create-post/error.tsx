...
const log = logger.scope("community/circles/create-post");
...
export default function CreatePostError({
  ...
  useEffect(() => {
    log.error("Post creation error boundary caught:", error);
    reportError(error, {
      component: "CreatePostError",
      route: "/nucleus/community/circles/create-post",
      digest: error.digest,
    });
  }, [error]);
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4 p-8">
      <h2 className="text-xl font-semibold">
        Something went wrong with post creation.
      </h2>
