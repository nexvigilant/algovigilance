...
const log = logger.scope("community/circles/projects");

export default function CircleProjectsError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    log.error("Circle projects error boundary caught:", error);
    reportError(error, {
      component: "CircleProjectsError",
      route: "/nucleus/community/circles/[category]/projects",
      digest: error.digest,
    });
  }, [error]);
