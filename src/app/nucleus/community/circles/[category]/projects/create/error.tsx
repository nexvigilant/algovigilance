...
const log = logger.scope("community/circles/project-create");
...
export default function CreateProjectError({
  ...
  useEffect(() => {
    log.error("Project creation error boundary caught:", error);
    reportError(error, {
      component: "CreateProjectError",
      route: "/nucleus/community/circles/[category]/projects/create",
      digest: error.digest,
    });
  }, [error]);
