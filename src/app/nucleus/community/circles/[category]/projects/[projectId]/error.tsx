...
const log = logger.scope("community/circles/project");
...
export default function ProjectDetailError({
  ...
  useEffect(() => {
    log.error("Project detail error boundary caught:", error);
    reportError(error, {
      component: "ProjectDetailError",
      route: "/nucleus/community/circles/[category]/projects/[projectId]",
      digest: error.digest,
    });
  }, [error]);
