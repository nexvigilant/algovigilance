...
const log = logger.scope("community/circles/post");
...
export default function PostDetailError({
  ...
  useEffect(() => {
    log.error("Post detail error boundary caught:", error);
    reportError(error, {
      component: "PostDetailError",
      route: "/nucleus/community/circles/post/[postId]",
      digest: error.digest,
    });
  }, [error]);
