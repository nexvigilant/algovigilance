...
const log = logger.scope("community/circles/create");
...
export default function CreateCircleError({
  ...
  useEffect(() => {
    log.error("Circle creation error boundary caught:", error);
    reportError(error, {
      component: "CreateCircleError",
      route: "/nucleus/community/circles/create",
      digest: error.digest,
    });
  }, [error]);
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4 p-8">
      <h2 className="text-xl font-semibold">
        Something went wrong with circle creation.
      </h2>
