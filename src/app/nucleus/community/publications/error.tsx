...
const log = logger.scope("community/publications");
...
export default function PublicationsError({
  ...
  useEffect(() => {
    log.error("Publications error boundary caught:", error);
    reportError(error, {
      component: "PublicationsError",
      route: "/nucleus/community/publications",
      digest: error.digest,
    });
  }, [error]);
