...
const log = logger.scope("community/case-studies");
...
export default function CaseStudiesError({
  ...
  useEffect(() => {
    log.error("Case studies error boundary caught:", error);
    reportError(error, {
      component: "CaseStudiesError",
      route: "/nucleus/community/case-studies",
      digest: error.digest,
    });
  }, [error]);
