...
const log = logger.scope("community/admin/governance");
...
export default function GovernanceError({
  ...
  useEffect(() => {
    log.error("Governance error boundary caught:", error);
    reportError(error, {
      component: "GovernanceError",
      route: "/nucleus/community/admin/governance",
      digest: error.digest,
    });
  }, [error]);
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4 p-8">
      <h2 className="text-xl font-semibold">
        Something went wrong loading governance.
      </h2>
