...
const log = logger.scope("community/onboarding");
...
export default function OnboardingError({
  ...
  useEffect(() => {
    log.error("Onboarding error boundary caught:", error);
    reportError(error, {
      component: "OnboardingError",
      route: "/nucleus/community/onboarding",
      digest: error.digest,
    });
  }, [error]);
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4 p-8">
      <h2 className="text-xl font-semibold">
        Something went wrong with onboarding.
      </h2>
