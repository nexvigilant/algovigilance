...
const log = logger.scope("community/benchmarks");
...
export default function BenchmarksError({
  ...
  useEffect(() => {
    log.error("Benchmarks error boundary caught:", error);
    reportError(error, {
      component: "BenchmarksError",
      route: "/nucleus/community/benchmarks",
      digest: error.digest,
    });
  }, [error]);
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4 p-8">
      <h2 className="text-xl font-semibold">
        Something went wrong loading benchmarks.
      </h2>
