...
const log = logger.scope("community/members/profile");
...
export default function MemberProfileError({
  ...
  useEffect(() => {
    log.error("Member profile error boundary caught:", error);
    reportError(error, {
      component: "MemberProfileError",
      route: "/nucleus/community/members/[userId]",
      digest: error.digest,
    });
  }, [error]);
