...
import { HeartHandshake, ChevronRight, ChevronLeft, Lightbulb, CheckCircle2, Target } from 'lucide-react';
...
export function RelationshipStep({ responses, onUpdate, onNext, onBack }: RelationshipStepProps) {
  const section = NAVIGATOR_SECTIONS.find(s => s.id === 'relationships') ?? NAVIGATOR_SECTIONS[0];
  const instructions = STEP_INSTRUCTIONS.relationships;
