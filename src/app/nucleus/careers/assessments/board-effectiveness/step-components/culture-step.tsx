...
const CULTURE_ITEMS: ChecklistItemConfig[] = [
  {
    id: 'meetingEffectiveness',
    label: 'Meeting Effectiveness',
    description: 'Well-structured meetings with clear agendas, preparation, and productive discussion',
  },
  {
    id: 'constructiveDebate',
    label: 'Constructive Debate',
    description: 'Culture that encourages respectful challenge and diverse viewpoints',
  },
  {
    id: 'informationFlow',
    label: 'Information Flow',
    description: 'Board receives timely, relevant, and unfiltered information',
  },
  {
    id: 'continuousLearning',
    label: 'Continuous Learning',
    description: 'Ongoing board education and development activities',
  },
  {
    id: 'boardEvaluation',
    label: 'Board Evaluation',
    description: 'Regular, meaningful self-evaluation with action on findings',
  },
];
...
export function CultureStep({ responses, onUpdate, onNext, onBack }: CultureStepProps) {
  const [localResponses, setLocalResponses] = useState({
    meetingEffectiveness: responses.meetingEffectiveness,
    constructiveDebate: responses.constructiveDebate,
    informationFlow: responses.informationFlow,
    continuousLearning: responses.continuousLearning,
    boardEvaluation: responses.boardEvaluation,
  });
    ...
    <div className="space-y-6">
      <div className="p-4 bg-gradient-to-r from-pink-500/10 to-transparent border-l-4 border-pink-500 rounded-r-lg">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-semibold text-foreground">7. Board Culture & Dynamics</h2>
            <p className="text-sm text-muted-foreground">
              How the board operates, learns, and works together
            </p>
          </div>
        </div>
      </div>
