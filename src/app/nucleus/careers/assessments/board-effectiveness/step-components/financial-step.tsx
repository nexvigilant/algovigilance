...
const FINANCIAL_ITEMS: ChecklistItemConfig[] = [
  {
    id: 'financialLiteracy',
    label: 'Financial Literacy',
    description: 'Board members have sufficient financial expertise to understand reports and implications',
  },
  {
    id: 'budgetOversight',
    label: 'Budget Oversight',
    description: 'Meaningful involvement in budget development and ongoing monitoring',
  },
  {
    id: 'financialReporting',
    label: 'Financial Reporting',
    description: 'Regular, clear, and comprehensive financial reports provided to the board',
  },
  {
    id: 'capitalAllocation',
    label: 'Capital Allocation',
    description: 'Board actively participates in major capital allocation and investment decisions',
  },
  {
    id: 'financialRisk',
    label: 'Financial Risk',
    description: 'Adequate oversight of financial risks including liquidity, credit, and market risks',
  },
];
...
export function FinancialStep({ responses, onUpdate, onNext, onBack }: FinancialStepProps) {
  const [localResponses, setLocalResponses] = useState({
    financialLiteracy: responses.financialLiteracy,
    budgetOversight: responses.budgetOversight,
    financialReporting: responses.financialReporting,
    capitalAllocation: responses.capitalAllocation,
    financialRisk: responses.financialRisk,
  });
  ...
  return (
    <div className="space-y-6">
      <div className="p-4 bg-gradient-to-r from-emerald-500/10 to-transparent border-l-4 border-emerald-500 rounded-r-lg">
        <div className="flex items-center gap-3">
          <DollarSign className="h-6 w-6 text-emerald-500" />
          <div>
            <h2 className="text-xl font-semibold text-foreground">3. Financial Stewardship</h2>
            <p className="text-sm text-muted-foreground">
              Oversight of financial health, resources, and reporting
            </p>
          </div>
        </div>
      </div>
