...
const LEADERSHIP_ITEMS: ChecklistItemConfig[] = [
  {
    id: 'ceoRelationship',
    label: 'CEO Relationship',
    description: 'Productive, trust-based relationship between board and CEO with appropriate boundaries',
  },
  {
    id: 'ceoEvaluation',
    label: 'CEO Evaluation',
    description: 'Regular, structured evaluation of CEO performance against clear objectives',
  },
  {
    id: 'successionPlanning',
    label: 'Succession Planning',
    description: 'Robust CEO and executive succession plans maintained and periodically tested',
  },
  {
    id: 'executiveCompensation',
    label: 'Executive Compensation',
    description: 'Compensation structures aligned with performance and organizational values',
  },
  {
    id: 'leadershipDevelopment',
    label: 'Leadership Development',
    description: 'Board involvement in developing leadership pipeline and talent strategy',
  },
];
...
export function LeadershipStep({ responses, onUpdate, onNext, onBack }: LeadershipStepProps) {
  const [localResponses, setLocalResponses] = useState({
    ceoRelationship: responses.ceoRelationship,
    ceoEvaluation: responses.ceoEvaluation,
    successionPlanning: responses.successionPlanning,
    executiveCompensation: responses.executiveCompensation,
    leadershipDevelopment: responses.leadershipDevelopment,
  });
    ...
    <div className="space-y-6">
      <div className="p-4 bg-gradient-to-r from-amber-500/10 to-transparent border-l-4 border-amber-500 rounded-r-lg">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-semibold text-foreground">5. CEO & Leadership</h2>
            <p className="text-sm text-muted-foreground">
              Board relationship with executive leadership and succession
            </p>
          </div>
        </div>
      </div>
