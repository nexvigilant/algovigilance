...
const GOVERNANCE_ITEMS: ChecklistItemConfig[] = [
  {
    id: 'governanceFramework',
    label: 'Governance Framework',
    description: 'Clear governance structure with defined roles, responsibilities, and decision rights',
  },
  {
    id: 'regulatoryCompliance',
    label: 'Regulatory Compliance',
    description: 'Systematic approach to identifying and ensuring compliance with applicable regulations',
  },
  {
    id: 'ethicsStandards',
    label: 'Ethics Standards',
    description: 'Established code of ethics with clear expectations and enforcement mechanisms',
  },
  {
    id: 'conflictManagement',
    label: 'Conflict Management',
    description: 'Effective processes for identifying, disclosing, and managing conflicts of interest',
  },
  {
    id: 'documentationPractices',
    label: 'Documentation Practices',
    description: 'Thorough documentation of board decisions, rationale, and follow-up actions',
  },
  {
    id: 'auditOversight',
    label: 'Audit Oversight',
    description: 'Effective oversight of internal and external audit functions',
  },
];
...
export function GovernanceStep({ responses, onUpdate, onNext, onBack }: GovernanceStepProps) {
  const [localResponses, setLocalResponses] = useState({
    governanceFramework: responses.governanceFramework,
    regulatoryCompliance: responses.regulatoryCompliance,
    ethicsStandards: responses.ethicsStandards,
    conflictManagement: responses.conflictManagement,
    documentationPractices: responses.documentationPractices,
    auditOversight: responses.auditOversight,
  });
    ...
    <div className="space-y-6">
      <div className="p-4 bg-gradient-to-r from-purple-500/10 to-transparent border-l-4 border-purple-500 rounded-r-lg">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-semibold text-foreground">2. Governance & Compliance</h2>
            <p className="text-sm text-muted-foreground">
              Legal, ethical, and structural governance foundations
            </p>
          </div>
        </div>
      </div>
