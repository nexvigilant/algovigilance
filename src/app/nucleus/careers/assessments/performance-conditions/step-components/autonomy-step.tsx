...
const AUTONOMY_ITEMS: PreferenceItem[] = [
  {
    id: 'autoDecisionAuthority',
    label: 'Decision Authority',
    leftLabel: 'Clear Direction',
    rightLabel: 'Full Authority',
    leftDescription: 'Decisions made by leadership',
    rightDescription: 'Make all decisions myself',
  },
  {
    id: 'autoScheduleFlexibility',
    label: 'Time Management',
    leftLabel: 'Set Schedule',
    rightLabel: 'Complete Control',
    leftDescription: 'Fixed hours, predictable',
    rightDescription: 'Manage my own time entirely',
  },
  {
    id: 'autoMethodFreedom',
    label: 'How I Work',
    leftLabel: 'Defined Processes',
    rightLabel: 'Freedom to Innovate',
    leftDescription: 'Clear SOPs and methods',
    rightDescription: 'Create my own approaches',
  },
  {
    id: 'autoPrioritySetting',
    label: 'Priority Setting',
    leftLabel: 'Priorities Assigned',
    rightLabel: 'I Set Priorities',
    leftDescription: 'Clear direction on what matters',
    rightDescription: 'Determine what to focus on',
  },
  {
    id: 'autoResourceControl',
    label: 'Resource Control',
    leftLabel: 'Resources Provided',
    rightLabel: 'Budget Authority',
    leftDescription: 'Resources allocated to me',
    rightDescription: 'Control my own budget/resources',
  },
];
    ...
    <div className="p-4 bg-nex-dark rounded-lg border border-nex-border">
      ...
      <div className="flex justify-between text-sm mb-2">
        ...
        <div className="text-right">
          <div className="font-medium text-purple-400">{item.rightLabel}</div>
...
export function AutonomyStep({ responses, onUpdate, onNext, onBack }: AutonomyStepProps) {
  const [localResponses, setLocalResponses] = useState({
    autoDecisionAuthority: responses.autoDecisionAuthority,
    autoScheduleFlexibility: responses.autoScheduleFlexibility,
    autoMethodFreedom: responses.autoMethodFreedom,
    autoPrioritySetting: responses.autoPrioritySetting,
    autoResourceControl: responses.autoResourceControl,
  });
    ...
    <div className="space-y-6">
      <div className="p-4 bg-gradient-to-r from-purple-500/10 to-transparent border-l-4 border-purple-500 rounded-r-lg">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-semibold text-foreground">2. Autonomy & Control</h2>
            <p className="text-sm text-muted-foreground">
              Your need for independence and decision-making authority
            </p>
          </div>
        </div>
      </div>
