...
const COLLABORATION_ITEMS: PreferenceItem[] = [
  {
    id: 'teamSize',
    label: 'Team Size',
    leftLabel: 'Solo/Small',
    rightLabel: 'Large Team',
    leftDescription: 'Work alone or 2-3 people',
    rightDescription: 'Part of large organization',
  },
  {
    id: 'teamInteractionFrequency',
    label: 'Interaction Frequency',
    leftLabel: 'Minimal Meetings',
    rightLabel: 'Frequent Collaboration',
    leftDescription: 'Async, independent work',
    rightDescription: 'Regular sync, constant contact',
  },
  {
    id: 'teamDiversity',
    label: 'Team Composition',
    leftLabel: 'Similar Background',
    rightLabel: 'Highly Diverse',
    leftDescription: 'Shared expertise/culture',
    rightDescription: 'Mixed backgrounds, perspectives',
  },
  {
    id: 'teamCompetitionVsCollaboration',
    label: 'Team Dynamic',
    leftLabel: 'Competitive',
    rightLabel: 'Collaborative',
    leftDescription: 'Individual achievement focus',
    rightDescription: 'Team success orientation',
  },
  {
    id: 'teamSocialConnection',
    label: 'Social Connection',
    leftLabel: 'Professional Only',
    rightLabel: 'Deep Relationships',
    leftDescription: 'Keep work boundaries',
    rightDescription: 'Build close friendships',
  },
];
    ...
    <div className="p-4 bg-nex-dark rounded-lg border border-nex-border">
      ...
      <div className="flex justify-between text-sm mb-2">
        <div className="text-left">
          <div className="font-medium text-indigo-400">{item.leftLabel}</div>
          <div className="text-xs text-muted-foreground">{item.leftDescription}</div>
        </div>
        <div className="text-right">
          <div className="font-medium text-pink-400">{item.rightLabel}</div>
...
export function CollaborationStep({ responses, onUpdate, onNext, onBack }: CollaborationStepProps) {
  const [localResponses, setLocalResponses] = useState({
    teamSize: responses.teamSize,
    teamInteractionFrequency: responses.teamInteractionFrequency,
    teamDiversity: responses.teamDiversity,
    teamCompetitionVsCollaboration: responses.teamCompetitionVsCollaboration,
    teamSocialConnection: responses.teamSocialConnection,
  });
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Your ideal team dynamics and social environment
            </p>
          </div>
        </div>
      </div>
      ...
      <Card className="bg-nex-surface border-nex-border">
        <CardHeader>
          ...
          <CardDescription>
            What team environment brings out your best work?
          </CardDescription>
        </CardHeader>
