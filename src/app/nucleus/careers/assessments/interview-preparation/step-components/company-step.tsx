...
import { Building2, ChevronRight, ChevronLeft, Lightbulb, CheckCircle2, ExternalLink } from 'lucide-react';
...
export function CompanyStep({ responses, onUpdate, onNext, onBack }: CompanyStepProps) {
  const area = RESEARCH_AREAS.find(a => a.id === 'company') ?? RESEARCH_AREAS[0];
  const instructions = STEP_INSTRUCTIONS.company;
