...
const WORKFLOWS: WorkflowCard[] = [
  {
    ...
    href: "/dashboards/case-intake",
    icon: ClipboardList,
    steps: 6,
    deliverable: "ICSR Case Report (PDF)",
    tools: ["ICSR Validation", "Seriousness (E2A)", "Expedited Reporting", "Naranjo"],
    color: "text-rose-500",
  },
  {
      ...
      <div className="flex items-center gap-3 rounded-lg border bg-muted/50 p-4">
        ...
        <div className="flex-1">
          <p className="text-sm text-muted-foreground">
            ...
            — 2,023 pharmacovigilance tools at mcp.nexvigilant.com. Every query
            hits live FDA, NIH, and NLM databases in real time.
          </p>
        </div>
      </div>
    </div>
